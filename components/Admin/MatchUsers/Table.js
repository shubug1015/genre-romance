...
const Table = ({
  ...
  const maleResetFilter = {
    firstAge: '',
    lastAge: '',
    place: '',
  };

  const femaleResetFilter = {
    firstAge: '',
    lastAge: '',
    place: '',
  };
  ...
  return (
    <Container>
      <TableContainer>
          ...
          <Filter>
            <div>
              <Input
                ...
                onChange={(e) => handleFirstAge(type, e.target.value)}
              />
              ...
              <Input
                ...
                onChange={(e) => handleLastAge(type, e.target.value)}
              />
            </div>
            <SelectBtn>
              <Select
                required
                defaultValue=""
                onChange={(e) => handlePlace(type, e.target.value)}
              >
              ...
              >
                <Btn onClick={() => submitFilter(maleFilter, femaleFilter)}>
                  필터 적용
                </Btn>
                <ResetBtn
                  onClick={() =>
                    submitFilter(maleResetFilter, femaleResetFilter)
                  }
                >
                  초기화
                </ResetBtn>
        ...
        <TabelContent>
          <TableHeader>
            <TableCell widthProp={'10%'}>선택</TableCell>
