...
const Privacy = () => (
  <Container>
    <Head>
      <title>개인정보처리방침 | 장르는로맨스</title>
      <meta
        name='description'
        content='장르는 로맨스의 개인정보처리방침입니다.'
      />
      <link rel='canonical' href='https://www.genreisromance.site/privacy' />
    </Head>
    <Title>개인정보처리방침</Title>
    <Content>
      장르는로맨스 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "정보통신망
      ...
      수집하고 있습니다.
      <br />
      - 회원가입시 : 이름, 성별, 로그인ID, 비밀번호, 휴대전화번호
      <br />
      o 서비스 이용 과정이나 사업 처리 과정에서 서비스이용기록, 접속로그, 쿠키,
      접속 IP, 결제 기록, 불량이용 기록이 생성되어 수집될 수 있습니다.
      <br />
      <br />
      나. 수집방법
      <br />
      ...
      수사기관의 요청에 따른 협조를 위하여, 이용계약 해지일로부터 oo년간 회원의
      정보를 보유할 수 있습니다.
      <br />
      <br />
      ...
      o 이용자들이 사전에 동의한 경우
      <br />
      o 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와 방법에 따라
      수사기관의 요구가 있는 경우
      <br />
      <br />
      ■ 이용자 및 법정대리인의 권리와 그 행사방법
      <br />
      o 이용자는 언제든지 등록되어 있는 자신의 개인정보를 조회하거나 수정할 수
      ...
      <br />
      o 혹은 개인정보보호책임자에게 서면, 전화 또는 이메일로 연락하시면 지체없이
      조치하겠습니다.
      <br />
      o 귀하가 개인정보의 오류에 대한 정정을 요청하신 경우에는 정정을 완료하기
      전까지 당해 개인정보를 이용 또는 제공하지 않습니다. 또한 잘못된 개인정보를
      제3자에게 이미 제공한 경우에는 정정 처리결과를 제3자에게 지체없이 통지하여
      정정이 이루어지도록 하겠습니다.
      <br />
      o 회사는 이용자의 요청에 의해 해지 또는 삭제된 개인정보는 "회사가 수집하는
      ...
      인터넷 옵션 {'>'} 개인정보
      <br />
      3. 단, 귀하께서 쿠키 설치를 거부하였을 경우 서비스 제공에 어려움이 있을 수
      있습니다.
      <br />
      <br />
      ■ 개인정보에 관한 민원서비스
      ...
      아래와 같이 관련 부서 및 개인정보보호책임자를 지정하고 있습니다.
      <br />
      o 개인정보보호담당자
      <br />
      성명 : 전유찬
      ...
      전화번호 : 010-6258-8828
      <br />
      이메일 : base227@naver.com
      <br />
      <br />
      o 귀하께서는 회사의 서비스를 이용하시며 발생하는 모든 개인정보보호 관련
