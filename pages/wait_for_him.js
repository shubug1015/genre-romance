...
const Wait = () => (
  <Container>
    <Head>
      <title>그의 답변을 기다리는 중입니다. | 장르는로맨스</title>
      <meta name='description' content='그의 답변을 기다리는 중입니다.' />
      <link
        rel='canonical'
        href='https://www.genreisromance.site/wait_for_him'
      />
    </Head>
    <LoadingImage>
      <Image
